...
def metric_plot_character(matrix, xaxis_labels, yaxis_labels, cbar_label,
                      title, fig_filename, fig_dir, pvalue=None):
...
if __name__ == "__main__":
    ...
    metric_plot_character(matrix, xaxis_labels, yaxis_labels, cbar_label,
                      title, fig_filename, fig_dir, pvalue=matrix_pvalue)
