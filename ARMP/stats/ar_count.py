...
def LFAR_count(fn_list, fn_var, region, season, fn_var, start_date, end_date, mask_lndocn, **kwargs):
    ...
    mask_reg, da_occur_ts, count_reg_mp, tag_reg_mpts = init_ds(fn_list, region, mask_lndocn, fn_var, **kwargs)
    ...
    with open(fn_list, 'r') as f:
        for fn in f:
            ...
            tag_reg_lf = data_QAQC(fn.strip(), mask_reg, region, season, fn_var, start_date, end_date, **kwargs)
...
def LFAR_count_mf(fn_list, region, season, fn_var, start_date, end_date, mask_lndocn, **kwargs):
    ...
    tag_reg_lf = data_QAQC_mf(fn_list, region, season, fn_var, start_date, end_date, mask_lndocn, **kwargs)
